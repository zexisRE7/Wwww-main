...
uint64_t calc_patch_hash(uint64_t vaddr,const char* patch)
{
    return [[[NSString stringWithUTF8String:patch] lowercaseString] hash] ^ vaddr;
}

NSString* StaticInlineHookPatch(const char* machoPath, uint64_t vaddr, const char* patch)
{
...
void* StaticInlineHookFunction(const char* machoPath, uint64_t vaddr, void* replace)
{
