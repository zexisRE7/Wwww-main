...
inline std::string str() {
    ...
    NSString *zString = [NSString stringWithFormat:@"%f", z];
    NSString *wString = [NSString stringWithFormat:@"%f", w];
    
    std::string result = [[NSString stringWithFormat:@"%@, %@, %@, %@", xString, yString, zString, wString] UTF8String];
