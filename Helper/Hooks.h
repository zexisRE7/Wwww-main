...
// ── Ammo Speed Fast — reload เร็ว + clip เต็มทุกเฟรม
...
// ── Reset Account — เรียก GarenaMSDK extern reset
static void DoResetAccount() {
    typedef void (*reset_t)();
    static reset_t _GarenaMSDK_ResetGuest = (reset_t)getRealOffset(0x5DFCBF8);
    if (_GarenaMSDK_ResetGuest) _GarenaMSDK_ResetGuest();
}
